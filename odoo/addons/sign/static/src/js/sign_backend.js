...
odoo.define('sign.template', function(require) {
    ...
    var SignItemCustomPopover = Widget.extend({
        ...
        start: function() {
            ...
            return this._super().then(function() {
                ...
                self.$('#o_sign_name').val(self.$currentTarget.data('name') || self.$currentTarget.prop('field-placeholder'));
    ...
    var EditablePDFIframe = PDFIframe.extend({
                        ...
                        const smoothScrollOptions = {
                            ...
                            jQueryDraggableOptions: {
                                ...
                                helper: function(e) {
                                    ...
                                    var $signatureItem = self.createSignItem(type, true, self.currentRole, 0, 0, type.default_width, type.default_height, '', [], type.placeholder);
                                    if(!e.ctrlKey) {
                                        self.$('.o_sign_sign_item').removeClass('ui-selected');
                                    }
        ...
        enableCustom: function($signatureItem) {
            ...
            $signatureItem.prop('field-placeholder', this.types[$signatureItem.data('type')].placeholder);
